    ...
    if (isset($_POST['submit'])) {
        ...
        if ($oldpassword == $oldpassworddb) {
            if ($newpassword == $repeatnewpassword) {
                ...
                session_destroy();
                header("Location: ../Form/formPage.php?message=Your password has been successfully updated.");
                exit();
            } else
                header("Location: changePassword.php?updatePassword=new");
            exit();
        } else
            header("Location: changePassword.php?updatePassword=old");
        exit();
    }
    echo file_get_contents('changePassword.php');
}
else
